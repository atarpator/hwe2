...
from sender.models import EmailSender, UNSENT_STATUS, SENT_STATUS, ERROR_STATUS
from sender.forms import EmailSenderForm
...
def update_status(request):
    ...
    return render(request,'update.html',{'object_list': queryset})
